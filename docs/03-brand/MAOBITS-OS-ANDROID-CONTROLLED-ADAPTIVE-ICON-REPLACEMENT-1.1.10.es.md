# Maobits OS Android — Reemplazo controlado de adaptive icons 1.1.10
...
Este documento define la **Fase 1.1.10 — Reemplazo controlado de adaptive icons**.

La fase 1.1.9 reemplazó los PNG launcher legacy. En Android moderno, el launcher suele usar los recursos adaptativos ubicados en `mipmap-anydpi-v26`. Por eso esta fase reemplaza de forma controlada:

```text
mipmap-anydpi-v26/ic_launcher.xml
mipmap-anydpi-v26/ic_launcher_round.xml
ic_launcher_foreground.png por densidad
color de fondo adaptive icon
```
...
```text
1.1.7 — Ícono aprobado.
1.1.8 — Conversión técnica generada.
1.1.9 — PNG launcher legacy reemplazados y validados.
```
...
Si falta el asset fuente aprobado, detener.
...
Si el launcher conserva caché del icono anterior, usar desinstalación controlada solo si no necesitas conservar datos:
...
[ ] No crashea.
[ ] El icono moderno se actualiza.
[ ] El icono no se ve recortado de forma grave.
[ ] La identidad visual aprobada se reconoce.
```
...
Esa fase documentará capturas reales, estado final de iconos, build/lint/test, y cierre formal del primer bloque de identidad visual.

---

## 16. Declaración final

Esta fase actualiza adaptive icons de forma auditable, con backup y rollback. Es la fase más probable para que Android moderno muestre el nuevo icono en el launcher real.
